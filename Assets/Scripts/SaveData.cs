...
public class SaveData {
    ...
    public SaveData(int xp, int level, int lastSceneIndex, List<SpellCaster.Spell> abilities) {
        ...
        if (abilities[0] == SpellCaster.Spell.LightningStorm)
        this.abilities[0] = 0;
        else
            this.abilities[0] = 1;
        ...
        if (abilities[0] == SpellCaster.Spell.EarthenSpike)
            this.abilities[1] = 0;
        else
            this.abilities[1] = 1;
        ...
        if (abilities[0] == SpellCaster.Spell.ArcaneBlast)
            this.abilities[2] = 0;
        else
            this.abilities[2] = 1;
        ...
        if (abilities[0] == SpellCaster.Spell.Phoenix)
            this.abilities[3] = 0;
        else
            this.abilities[3] = 1;
    }
